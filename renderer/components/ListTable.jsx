        ...
        <CardBody>
          <div className="flex flex-col gap-2">
            ...
            <Input
              ...
              onChange={(e) =>
                setNewBook({ ...newBook, paginas: e.target.value })
              }
            ...
            <Input
              ...
              onChange={(e) =>
                setNewBook({ ...newBook, precio: e.target.value })
              }
            ...
            <Input
              ...
              onChange={(e) =>
                setNewBook({ ...newBook, imagen: e.target.value })
              }
            ...
            <Input
              ...
              onChange={(e) =>
                setNewBook({ ...newBook, idioma: e.target.value })
              }
            ...
            <Input
              ...
              onChange={(e) =>
                setNewBook({ ...newBook, fecha_publicacion: e.target.value })
              }
