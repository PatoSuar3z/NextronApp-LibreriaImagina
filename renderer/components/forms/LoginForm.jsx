...
const LoginForm = () => {
  ...
  return (
    <form onSubmit={handleSubmit} className="flex flex-col gap-4">
      <input
        className="text-[#593535] text-sm p-2 mt-8 rounded-xl border"
        type="email"
        name="correo"
      ...
      <div className="relative">
        <input
          className="text-[#593535] text-sm p-2 rounded-xl border w-full"
          type="password"
          name="password"
      ...
      <button
        className="bg-[#664040] rounded-xl text-black py-2 hover:scale-105 duration-300"
        type="submit"
      >
        Login
      </button>
